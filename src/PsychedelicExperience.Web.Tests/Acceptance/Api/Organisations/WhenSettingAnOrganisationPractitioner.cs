...
{
    public class WhenSettingAnOrganisationPractitioner : ApiTest
    {
        private readonly Practitioner _practitioner = TestData.Practitioner();
        private Guid _organisationId;
        private TestAccount _account;

        public WhenSettingAnOrganisationPractitioner(WebIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        {
            ApiClient.Organisations.SetPractitioner(_account, _organisationId, _practitioner);
        }
        ...
        public void PropertyShouldBeSet()
        {
            Execute.WithTimeOut(() => ApiClient.Organisations.Get(_account, _organisationId),
                organisation => organisation.Practitioner != null
                    && organisation.Practitioner.Work.Medicines == _practitioner.Work.Medicines,
