...
{
    public class WhenLinkingAnOrganisation : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenLinkingAnOrganisation(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        protected override void When(TestContext<IMediator> context)
        {
            ...
            var query = new LinkOrganisation(_organisationId, _organisationTargetId, _userId, "Shaman");
        ...
        public void ThenTheAggregateShouldBeUpdated()
        {
            SessionScope(context =>
            {
                ...
                aggregate.Relations.ShouldContain(tag => tag.Target.Equals(_organisationTargetId));
            });
        }
