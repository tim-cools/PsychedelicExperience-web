...
{
    public class WhenAddOrganisationOwner : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenAddOrganisationOwner(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        protected override void When(TestContext<IMediator> context)
        {
            ...
            var query = new AddOrganisationOwner(_organisationId, _userId, null, _ownerId);
    ...
    public class WhenAddOrganisationOwnerByAdmin : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        private readonly UserId _userId = UserId.New();
        private readonly UserId _ownerId = UserId.New();
        private OrganisationId _organisationId;
        ...
        public WhenAddOrganisationOwnerByAdmin(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        public void ThenTheAggregateShouldBeUpdated()
        {
            SessionScope(context =>
            {
                ...
                aggregate.Owners.Contains(_ownerId.Value).ShouldBeTrue();
            });
        }
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                var @event = events.LastEventShouldBeOfType<OrganisationOwnerAdded>();
    ...
    public class WhenAddOrganisationOwnerByEMail : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenAddOrganisationOwnerByEMail(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        protected override void When(TestContext<IMediator> context)
        {
            var user = context.AddUser(_userId);
            context.AddAdministrator(_administratorId);

            _organisationId = context.AddOrganisation(_userId);

            var query = new AddOrganisationOwner(_organisationId, _administratorId, (EMail) user.Email, null);
            _result = context.Service.ExecuteNowWithTimeout(query);
        }
        ...
        public void ThenTheAggregateShouldBeUpdated()
        {
            SessionScope(context =>
            {
                ...
                aggregate.ShouldNotBeNull();
                aggregate.Owners.ShouldContain(_userId.Value);
            });
        }
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                @event.UserId.ShouldBe(_administratorId);
                @event.OrganisationId.ShouldBe(_organisationId);
                @event.OwnerId.ShouldBe(_userId);
            });
        }
    }
}