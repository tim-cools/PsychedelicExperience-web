...
{
    public class WhenRemoveOrganisationTag : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        private readonly UserId _userId = UserId.New();
        private OrganisationId _organisationId;
        private Result _result;

        public WhenRemoveOrganisationTag(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        protected override void When(TestContext<IMediator> context)
        {
            ...
            context.AddOrganisationTag(_userId, _organisationId, "Retreat");

            var query = new RemoveOrganisationTag(_organisationId, _userId, "Retreat");
        ...
        public void ThenTheAggregateShouldBeUpdated()
        {
            SessionScope(context =>
            {
                ...
                aggregate.Tags.ShouldNotContain(tag => tag.Name == "Retreat");
            });
        }
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                var @event = events.LastEventShouldBeOfType<OrganisationTagRemoved>();
