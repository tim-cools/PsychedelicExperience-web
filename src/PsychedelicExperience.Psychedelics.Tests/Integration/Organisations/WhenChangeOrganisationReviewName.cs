...
{
    public class WhenChangeOrganisationReviewName : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        private readonly UserId _userId = UserId.New();
        private OrganisationReviewId _organisationReviewId;
        private Result _result;

        public WhenChangeOrganisationReviewName(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        protected override void When(TestContext<IMediator> context)
        {
            ...
            var query = new ChangeOrganisationReviewName(_organisationReviewId, _userId,"newName");
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                var @event = events.LastEventShouldBeOfType<OrganisationReviewNameChanged>();
