...
{
    public class WhenRemoveOrganisationReview : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        private readonly UserId _userId = UserId.New();
        private OrganisationReviewId _organisationReviewId;
        private Result _result;

        public WhenRemoveOrganisationReview(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        protected override void When(TestContext<IMediator> context)
        {
            ...
            var query = new RemoveOrganisationReview(_organisationReviewId, _userId);
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                var @event = events.LastEventShouldBeOfType<OrganisationReviewRemoved>();
