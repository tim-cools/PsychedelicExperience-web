...
{
    public class WhenRemoveOrganisationUpdateAsOwner : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenRemoveOrganisationUpdateAsOwner(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        protected override void When(TestContext<IMediator> context)
        {
            ...
            var query = new RemoveOrganisationUpdate(_userId, _organisationId, _updateId);
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                var @event = events.LastEventShouldBeOfType<OrganisationUpdateRemoved>();

                @event.UserId.ShouldBe(_userId);
                @event.OrganisationId.ShouldBe(_organisationId);
                @event.UpdateId.ShouldBe(_updateId);
            });
        }
    }

    public class WhenRemoveOrganisationUpdateAsAdministrator : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        private readonly UserId _administratId = UserId.New();
        private OrganisationUpdateId _updateId;
        private OrganisationId _organisationId;
        ...
        public WhenRemoveOrganisationUpdateAsAdministrator(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        protected override void When(TestContext<IMediator> context)
        {
            ...
            var query = new RemoveOrganisationUpdate(_administratId, _organisationId, _updateId);
            _result = context.Service.ExecuteNowWithTimeout(query);
        }
    ...
    public class WhenRemoveOrganisationUpdateAsInvalidUser : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        private readonly UserId _userId = UserId.New();
        private readonly UserId _administratId = UserId.New();
        private OrganisationUpdateId _updateId;
        ...
        public WhenRemoveOrganisationUpdateAsInvalidUser(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
