...
{
    public class WhenRemoveEvent : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        private EventId _eventId;
        private RemoveEvent _command;
        private UserId _userId;
        private Result _result;

        public WhenRemoveEvent(PsychedelicsIntegrationTestFixture fixture)
        ...
        protected override void When(TestContext<IMediator> context)
        {
            ...
            _command = new RemoveEvent(_userId, _eventId);
        ...
        public void ThenTheAggregateShouldBeUpdated()
        {
            SessionScope(context =>
            {
                ...
                aggregate.Removed.ShouldBe(true);
            });
        }
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                var @event = events.LastEventShouldBeOfType<EventRemoved>();
