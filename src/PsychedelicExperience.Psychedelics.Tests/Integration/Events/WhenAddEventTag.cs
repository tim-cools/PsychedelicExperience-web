...
{
    public class WhenAddEventTag : ServiceTestBase<IMediator>, IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        private EventId _eventId;
        private AddEventTag _command;
        private UserId _userId;
        private Result _result;

        public WhenAddEventTag(PsychedelicsIntegrationTestFixture fixture)
        ...
        protected override void When(TestContext<IMediator> context)
        {
            ...
            _command = new AddEventTag(_eventId, _userId, new Name("Tag1"));
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                var @event = events.LastEventShouldBeOfType<EventTagAdded>();
