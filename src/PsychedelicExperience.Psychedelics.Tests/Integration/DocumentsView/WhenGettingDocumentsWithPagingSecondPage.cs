...
{
    public class WhenGettingDocumentsWithPagingSecondPage : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenGettingDocumentsWithPagingSecondPage(PsychedelicsIntegrationTestFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        {
            var query = new GetDocuments(_userId, tags: new[] { "include" }, page: 1);
        ...
        public void ThenTheSecond20ItemsShouldBeReturned()
        {
            ...
            {
                _result.Documents[index].Name.ShouldBe($"name{(index + 20) * 2:000}");
            }
        }
