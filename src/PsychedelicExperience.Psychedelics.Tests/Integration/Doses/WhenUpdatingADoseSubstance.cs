...
{
    public class WhenUpdatingADoseSubstance : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenUpdatingADoseSubstance(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        {
            var query = new UpdateDoseSubstance(_userId, _doseId, "5-meo-dmt");
        ...
        public void ThenTheDoseShouldBeUpdated()
        {
            SessionScope(context =>
            {
                Test.All(_ => _.IsNotNull(context.Session.Load<Dose>(_doseId), (dose, __) => __
                    ...
                    .AreEqual(dose.Substance, "5-meo-dmt")));
            });
        }
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                Test.All(_ => _.IsNotNull(events.LastEventShouldBeOfType<DoseSubstanceUpdated>(), (@event, __) => __
                    .AreEqual(@event.DoseId, _doseId, "doseId")
                    .AreEqual(@event.UserId, _userId, "userId")
                    .AreEqual(@event.Substance, "5-meo-dmt")));
            });
        }
    }
}