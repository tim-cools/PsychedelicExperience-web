...
{
    public class WhenUpdatingADoseMethod : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenUpdatingADoseMethod(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        {
            var query = new UpdateDoseMethod(_userId, _doseId, "nasal");
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                Test.All(_ => _.IsNotNull(events.LastEventShouldBeOfType<DoseMethodUpdated>(), (@event, __) => __
                    .AreEqual(@event.DoseId, _doseId, "doseId")
                    .AreEqual(@event.UserId, _userId, "userId")
                    .AreEqual(@event.Method, "nasal")));
            });
        }
    }
}