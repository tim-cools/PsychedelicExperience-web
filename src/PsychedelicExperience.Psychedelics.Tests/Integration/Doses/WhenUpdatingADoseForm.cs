...
{
    public class WhenUpdatingADoseForm : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenUpdatingADoseForm(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        {
            var query = new UpdateDoseForm(_userId, _doseId, "extract");
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                Test.All(_ => _.IsNotNull(events.LastEventShouldBeOfType<DoseFormUpdated>(), (@event, __) => __
                    .AreEqual(@event.DoseId, _doseId, "doseId")
                    .AreEqual(@event.UserId, _userId, "userId")
                    .AreEqual(@event.Form, "extract")));
            });
        }
    }
}