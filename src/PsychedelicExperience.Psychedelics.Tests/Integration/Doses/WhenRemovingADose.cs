...
{
    public class WhenRemovingADose : ServiceTestBase<IMediator>,
         IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenRemovingADose(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        {
            var query = new RemoveDose(_doseId, _userId);
        ...
        [Fact]
        public void ThenTheDoseShouldBeRemoved()
        {
            SessionScope(context =>
            {
                context.Session.Load<Dose>(_experienceId).ShouldBeNull();
            });
        }
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                Test.All(_ => _.IsNotNull(events.LastEventShouldBeOfType<DoseRemoved>(), (@event, __) => __
