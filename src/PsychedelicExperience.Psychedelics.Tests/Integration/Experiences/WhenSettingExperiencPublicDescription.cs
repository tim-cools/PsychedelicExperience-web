...
{
    public class WhenSettingExperiencPublicDescription : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenSettingExperiencPublicDescription(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        {
            var query = new UpdateExperiencePublicDescription(_experienceId, _userId,new Description("new-description"));
        ...
        public void ThenTheEventShouldBeStored()
        {
            SessionScope(context =>
            {
                ...
                Test.All(_ => _.IsNotNull(events.LastEventShouldBeOfType<ExperiencePublicDescriptionChanged>(), (@event, __) => __
                    .AreEqual(@event.UserId, _userId, "userId")
                    .AreEqual(@event.ExperienceId, _experienceId, "_experienceId")
                    .AreEqual(@event.Description, new Description("new-description"))));
            });
        }
    }
}