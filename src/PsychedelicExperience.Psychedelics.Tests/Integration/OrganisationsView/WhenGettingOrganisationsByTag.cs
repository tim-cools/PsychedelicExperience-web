...
{
    public class WhenGettingOrganisationsByTag : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        private const string _include = "Retreat";
        private const string _exclude = "Community";
        private const string _exclude2 = "Conference";

        public WhenGettingOrganisationsByTag(PsychedelicsIntegrationTestFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
