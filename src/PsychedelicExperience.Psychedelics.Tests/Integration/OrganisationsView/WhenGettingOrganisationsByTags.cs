...
{
    public class WhenGettingOrganisationsByTags : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        private const string _include1 = "Shop";
        private const string _include2 = "Conference";
        private const string _exclude1 = "Religious";
        private const string _exclude2 = "Multimedia";

        public WhenGettingOrganisationsByTags(PsychedelicsIntegrationTestFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        protected override void Given(TestContext<IMediator> context)
        {
            ...
            _included.Add(AddOrganisation(context, _include1, _include2));

            _excluded.Add(AddOrganisation(context, _include1));
            _excluded.Add(AddOrganisation(context, _include2));
            _excluded.Add(AddOrganisation(context, _exclude1));
            _excluded.Add(AddOrganisation(context, _exclude2));
        }

        private Guid AddOrganisation(TestContext<IMediator> context, params string[] tags)
        {
            return (Guid)context
                .BuildOrganisation(_userId, "With " + tags.Length, _testOutputHelper)
                .WithTags(tags)
                .Id;
        }
        ...
        {
            var query = new GetOrganisations(_userId, tags: new[] { _include1, _include2 });
        ...
        public void ThenOrganisationsShouldBeReturned()
        {
            ...
            _result.Organisations.Length.ShouldBe(1);
