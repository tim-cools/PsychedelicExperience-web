...
{
    public class WhenGettingOrganisationsWithPagingSecondPage : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenGettingOrganisationsWithPagingSecondPage(PsychedelicsIntegrationTestFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        {
            var query = new GetOrganisations(_userId, tags: new[] { _include }, page: 1);
        ...
        public void ThenTheSecond20ItemsShouldBeReturned()
        {
            ...
            {
                _result.Organisations[index].Name.ShouldBe($"name{(index + 20) * 2:000}");
            }
        }
