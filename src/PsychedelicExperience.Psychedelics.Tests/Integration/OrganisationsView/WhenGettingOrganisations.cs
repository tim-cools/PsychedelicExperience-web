...
{
    public class WhenGettingOrganisations : ServiceTestBase<IMediator>,
         IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenGettingOrganisations(PsychedelicsIntegrationTestFixture fixture)
            : base(fixture)
        {
        }
        ...
        {
            var query = new GetOrganisations(_userId);
            _result = (JsonOrganisationsResult) context.Service.ExecuteNowWithTimeout(query);
        }
        ...
        public void ThenOrganisationsShouldBeReturned()
        {
            ...
            _result.Organisations.Length.ShouldBe(3);
            _result.Organisations
                .Select(result => new OrganisationId(result.OrganisationId))
