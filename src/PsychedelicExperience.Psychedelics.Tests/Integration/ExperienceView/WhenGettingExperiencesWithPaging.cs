...
{
    public class WhenGettingExperiencesWithPaging : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenGettingExperiencesWithPaging(PsychedelicsIntegrationTestFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        public void ThenTheFirst20ItemsShouldBeReturned()
        {
            ...
            {
                _result.Experiences[index].Title.ShouldBe((index * 2).ToString());
            }
        }
