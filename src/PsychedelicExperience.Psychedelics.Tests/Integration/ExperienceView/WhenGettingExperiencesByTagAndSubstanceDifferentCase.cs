...
{
    public class WhenGettingExperiencesByTagAndSubstanceDifferentCase : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenGettingExperiencesByTagAndSubstanceDifferentCase(PsychedelicsIntegrationTestFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        protected override void Given(TestContext<IMediator> context)
        {
            ...
            _included.Add(AddExperience(context, "iNc LuDe", Substances.LSD.ToLowerInvariant()));

            _excluded.Add(AddExperience(context, "inc lude", Substances.DMT));
        ...
        {
            var query = new GetExperiences(_userId, tags: new[] { "inc lude" }, substances: new[] { Substances.LSD });
