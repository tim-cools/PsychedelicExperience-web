...
{
    public class WhenGettingExperiencesBySubstanceDifferentCase : ServiceTestBase<IMediator>,
        IClassFixture<PsychedelicsIntegrationTestFixture>
    {
        ...
        public WhenGettingExperiencesBySubstanceDifferentCase(PsychedelicsIntegrationTestFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
        ...
        {
            var query = new GetExperiences(_userId, substances: new[] { Substances.LSD.ToLowerInvariant() });
