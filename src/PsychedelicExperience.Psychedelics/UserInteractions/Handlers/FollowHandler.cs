...
{
    public class FollowHandler : CommandHandler<Follow, Result>
    {
        public FollowHandler(IDocumentSession session) : base(session)
        {
        }

        protected override async Task<Result> Execute(Follow command)
        {
