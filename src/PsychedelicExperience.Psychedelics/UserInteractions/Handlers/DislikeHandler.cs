...
{
    public class DislikeHandler : CommandHandler<Dislike, Result>
    {
        public DislikeHandler(IDocumentSession session) : base(session)
        {
        }

        protected override async Task<Result> Execute(Dislike command)
        {
