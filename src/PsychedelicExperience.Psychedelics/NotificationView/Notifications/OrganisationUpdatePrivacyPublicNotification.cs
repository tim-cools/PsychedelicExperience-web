...
{
    public class OrganisationUpdatePrivacyPublicNotification : Notification
    {
        ...
        public OrganisationUpdatePrivacyPublicNotification()
        {
        }

        public OrganisationUpdatePrivacyPublicNotification(Guid userId, Context<OrganisationUpdatePrivacyChanged> context)
