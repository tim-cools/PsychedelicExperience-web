...
{
    public class ExperienceUnpublishedNotification : Notification
    {
        public Guid ExperienceId { get; set; }
        public Guid ChangedUserId { get; set; }
        public string Title { get; set; }

        public ExperienceUnpublishedNotification()
        {
        }

        public ExperienceUnpublishedNotification(Guid userId, Context<ExperiencePrivacyLevelChanged> context)
        ...
        public override Markup Format(IUserInfoResolver userInfoResolver) => new Markup()
            ...
            .Text(" changed your experience ")
            .Link(Title, $"/experience/{ExperienceId}")
            .Text(" to be private so it is only visible for yourself.");
    }
}